import { ArgumentMetadata, ValidationError, ValidationPipe, ValidationPipeOptions } from '@nestjs/common';
...
function transformErrors(args: { param: any[]; message: any[] }, errors: ValidationError[], parentProperty = '') {
